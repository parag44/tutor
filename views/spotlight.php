            ...
            <div class="tutor-default-tab tutor-course-details-tab">
                ...
                <div class="tab-body">
                    ...
                    <div class="tab-body-item is-active" id="tutor-course-details-tab-3">
                        ...
                        <div class="tutor-conversation tutor-mt-12">
                            ...
                            <div class="tutor-comments-list tutor-mt-30">
                                <div class="comment-avatar">
                                    <img src="https://i.imgur.com/CckCKYQ.jpeg" alt="">
                                </div>
                                <div class="tutor-single-comment">
                                    <div class="tutor-actual-comment tutor-p-20 tutor-mb-10">
                                        <div class="tutor-comment-author">
                                            <span class="text-bold-body">Estella Clayton</span>
                                            <span class="text-regular-caption tutor-ml-10">1 week ago</span>
                                        </div>
                                        <div class="tutor-comment-text text-regular-body">
