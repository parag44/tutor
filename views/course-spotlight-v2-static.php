	...
	<div class="tutor-lesson-sidebar">
		<div class="tutor-sidebar-tabs-wrap">
			<div class="tutor-lessons-tab">
				<div class="tutor-lessons-lessons-tab active flex-center">
			...
			<div id="tutor-quiz-multiple-choice" class="tutor-quiz-wrap">
				<div class="quiz-meta-info d-flex justify-content-between">
					<div class="quiz-meta-info-left d-flex">
						<div class="quiz-qno d-flex">
						   <p class="text-regular-body color-text-hints tutor-mr-10">Questions No:</p> <span class="text-bold-body color-text-title">01/15</span>
						</div>
						<div class="quiz-total-attempt d-flex">
						    <p class="text-regular-body color-text-hints tutor-mr-10">Total Attempted:</p> <span class="text-bold-body color-text-title">8/20</span>
						</div>
					</div>
					<div class="quiz-meta-info-right">
						<div class="quiz-time-remaining d-flex">
							...
							<p class="text-regular-body color-text-hints tutor-mr-10">Time remaining:</p> <span class="text-medium-body color-text-title">7:30:48</span>
						</div>
					</div>
				</div>  <!-- quiz-meta-info -->
				<div class="quiz-question">
				    ...
				    <div class="quiz-question-desc text-regular-caption color-text-subsued">
					    Over 92% of computers are infected with Adware and spyware. Such software is rarely accompanied by uninstall utility and even when it is it almost always leaves broken.
					</div>
				</div> <!-- quiz-question -->
				<div class="quiz-question-ans-choice-area">
                    <div class="quiz-question-ans-choice">
					    <input type="checkbox" class="tutor-form-check-input" /> <span class="text-regular-body text-primary">Computer Science & Technology</span>
					</div>
				</div>
				<div class="tutor-quiz-btn-grp">
					<button class="tutor-btn tutor-btn-primary tutor-btn-md start-quiz-btn">
