    ...
    <div class="quiz-question tutor-mt-60">
        ...
        <div class="matching-quiz-question-desc">
            <div class="tutor-quiz-border-box" draggable="true">
                <span class="text-regular-body color-text-primary">Computer 1</span>
                <span class="ttr-humnurger-filled color-black-fill"></span>
                <input type="text" value="1">
            </div>
            <div class="tutor-quiz-border-box" draggable="true">
                <span class="text-regular-body color-text-primary">Computer 2</span>
                <span class="ttr-humnurger-filled color-black-fill"></span>
                <input type="text" value="2">
            </div>
            <div class="tutor-quiz-border-box" draggable="true">
                <span class="text-regular-body color-text-primary">Computer 3</span>
                <span class="ttr-humnurger-filled color-black-fill"></span>
                <input type="text" value="3">
            </div>
            <div class="tutor-quiz-border-box" draggable="true">
                <span class="text-regular-body color-text-primary">Computer 4</span>
                <span class="ttr-humnurger-filled color-black-fill"></span>
